...
class GmailAnalysisIntegration:
    ...
    def __init__(self, base_dir: str | None = None):
        ...
        # Integration paths
        self.gman_script = self.base_dir / 'gman.py'
    ...
    def _run_gman(self,
        ...
        try:
            ...
            cmd = [
                sys.executable, str(self.gman_script),
                '--query', query,
                '--max', str(max_emails),
                '--format', format_type,
                '--organize', organize
...
from gman.core.ai.analysis_integration import GmailAnalysisIntegration
