"""
Standardized logging utilities for Gman.

Usage:
    from gman.utils.logging_utils import get_logger
...
def set_package_log_level(level: int) -> None:
    """
    Set log level for all gman loggers.

    Args:
        level: Logging level to set
    """
    logging.getLogger('gman').setLevel(level)
